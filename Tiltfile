...
# Compose demo-react-app frontend Docker image
docker_compose('./tilt/react/docker-compose.yml')

# Build demo-react-app frontend Docker image
# Should only `yarn install` if packages update
docker_build(
    'tilt/react/demo-react-app-image', 
    context='.',
    dockerfile='./tilt/react/Dockerfile',
    only=['./demo-react-app/'],
    build_args={'node_env': 'development'},
    live_update=[
        sync('./demo-react-app/', '/user/src/app/'),
        run(
            'yarn install',
            trigger=['./demo-react-app/package.json', './demo-react-app/yarn.lock']
        )
    ]
